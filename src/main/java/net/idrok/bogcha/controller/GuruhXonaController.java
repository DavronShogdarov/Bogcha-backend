...
import net.idrok.bogcha.service.GuruhXonaService;
...
public class GuruhXonaController {
    ...
    @PostMapping()
    public ResponseEntity<GuruhXona> postMethodName(@RequestBody GuruhXona entity) {
    ...
    public ResponseEntity<Boolean> deleteMethodName(@PathVariable Long id) {
        return ResponseEntity.ok(gxs.deleteById(id));
    }
}
